...
public class BoardManager : MonoBehaviour {
    ...
    // will be called by the GameManager
    ...
    Vector3 RandomPosition()
    {
        ...
        // not to create two objects at the same position
